...
- **Phase 3**: TTS voice guidance (Sherpa-ONNX, gated on audio=VOICE) + chime sync to phase boundaries + reduced-motion path + keyboard shortcuts (ESC/SPACE — desktop/web concern, ships with Phase 3) + TalkBack pass + cross-locale screenshot regression + marketing screenshots.
