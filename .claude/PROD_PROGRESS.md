...
- [~] **Sprint i18n pre-Level 3 (~5-6 gg, Fase A + A' + A'' + B + C.1 DONE 2026-04-19)** — EN default + 12 lingue ALL SCAFFOLDED + common keys populated + home module fully migrated (~37 hardcoded + 29 new keys × 12 lang). Next: Fase C tail (~100 strings per-module rimanenti). Vedi `memory/i18n_strategy.md`
