...
data class Badge(
    ...
    val earnedAt: Instant? = null,       // Null if not yet earned
...
object KnownBadges {
    ...
    data class BadgeDefinition(
        ...
        fun toBadge(earnedAt: Instant? = null, progress: Float = 0f, isNew: Boolean = false): Badge {
            return Badge(
                id = id,
                name = name,
...
data class StreakData(
    ...
    val lastWriteDate: Instant?,         // Last diary write date
