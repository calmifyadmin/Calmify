...
data class MoodDistributionResult(
    ...
    val calculatedAt: ZonedDateTime,
    val sampleSize: Int
)
...
object KnownCognitivePatterns {
    ...
    private val patterns = mapOf(
        ...
        "labeling" to PatternInfo(
            name = "Etichettatura",
            description = "Attribuire etichette negative a sé o altri",
            sentiment = PatternSentiment.MALADAPTIVE
        ),
        ...
        "gratitude" to PatternInfo(
            name = "Gratitudine",
            description = "Apprezzamento per ciò che si ha",
            sentiment = PatternSentiment.ADAPTIVE
        ),
        "growth_mindset" to PatternInfo(
            name = "Mentalità di crescita",
            description = "Vedere le sfide come opportunità",
            sentiment = PatternSentiment.ADAPTIVE
        ),
        "self_compassion" to PatternInfo(
            name = "Auto-compassione",
            description = "Essere gentili con sé stessi",
            sentiment = PatternSentiment.ADAPTIVE
        ),
        ...
        "acceptance" to PatternInfo(
            name = "Accettazione",
            description = "Accettare ciò che non si può cambiare",
            sentiment = PatternSentiment.ADAPTIVE
        ),
...
object TopicCategories {
    ...
    val categories = mapOf(
        ...
        "creativity" to TopicCategory("Creatività", listOf("creatività", "arte", "musica", "scrittura", "hobby")),
