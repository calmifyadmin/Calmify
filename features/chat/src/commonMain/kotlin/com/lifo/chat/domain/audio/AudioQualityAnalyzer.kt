...
class AudioQualityAnalyzer {
    ...
    fun startMeasurement() {
        ...
        measurementStartTime = currentTimeMillis()
        isCapturing = true
        frameCount = 0L
        clearHistories()
    }
     ...
     */
    fun processCapturedFrame(audioFrame: ShortArray, timestamp: Long = currentTimeMillis()) {
     ...
     */
    fun processPlaybackFrame(audioFrame: ByteArray, timestamp: Long = currentTimeMillis()) {
        if (!isCapturing) return
    ...
    fun getQualityReport(): Map<String, Any> {
        return mapOf(
            ...
            "measurementDuration" to (currentTimeMillis() - measurementStartTime),
