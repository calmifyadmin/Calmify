...
class IdleRotationController(
    ...
    private val idleAnimations = listOf(
        WeightedAnimation(VrmaAnimationLoader.AnimationAsset.IDLE_LOOP, 40),           // 40% - default principale
        ...
        WeightedAnimation(VrmaAnimationLoader.AnimationAsset.IDLE_LOOK_FINGERS, 8)     // 8%  - guarda le dita
    )
